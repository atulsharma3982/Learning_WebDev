...
function App() {
  ...
  const [todos, setTodos] = useState([
    ...
    {
      title: "Hey I am also a todo",
      desc: "I am a good todo too another one"
    },
    {
      title: "Hey grocery",
      desc: "I am a good todo for grocery"
    }
  ])
        ...
        </div>
        {
          todos.map(
            todo => {
              ...
              return (
                <div key={todo.title} className="m-4 border-2 border-amber-300">
                  <div className="todo">{todo.title}</div>
                  <div className="desc">{todo.desc}</div>
                </div>
              )
